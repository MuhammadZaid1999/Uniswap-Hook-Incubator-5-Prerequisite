...
contract Child is Base {
    ...
    // Public function can be called inside child contracts.
    function testPublicFunc() public pure returns (string memory) {
        return publicFunc();
    }

    constructor() {
        // State variables can be changed in the child contract. 
        // Cannot change directly in without function / constructor
