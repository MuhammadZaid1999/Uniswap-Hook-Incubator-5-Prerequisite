...
contract UncheckedMath {
    ...
    function power(uint8 x, uint8 y) external pure returns (uint8) {
        // Wrap complex math logic inside unchecked
        unchecked {
            uint8 x3 = x * x * x;
            uint8 y3 = y * y * y;
    ...
    function power(uint32 x, uint32 y) external pure returns (uint32) {
        // Wrap complex math logic inside unchecked
        uint32 x3 = x * x * x;
        uint32 y3 = y * y * y;
    ...
    function power(uint64 x, uint64 y) external pure returns (uint64) {
        // Wrap complex math logic inside unchecked
        unchecked {
            uint64 x3 = x * x * x;
            uint64 y3 = y * y * y;
    ...
    function power(uint128 x, uint128 y) external pure returns (uint128) {
        // Wrap complex math logic inside unchecked
        uint128 x3 = x * x * x;
        uint128 y3 = y * y * y;
